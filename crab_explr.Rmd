...
These plots show the estimated likelihood of observing crabs for a given depth across ranges of values for an environmental varialbe.  The results are based on model averages from the model selection process.  Estimates are based across the range of values observed for a selected environmental variable, while holding the other variables in the model at their minimum, median, and maximum. 
