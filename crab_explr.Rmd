...
renderUI({
  ...
  cap.val<-paste0('Top five selected models for crab abundance at shallow and deep water. Input variables were ', paste(tolower(sort(crvrs)), collapse = ', '), '.')
...
renderUI({
  ...
  cap.val<-paste0('Top five selected models for crab presence/absence at shallow and deep water. Input variables were ', paste(tolower(sort(crvrs)), collapse = ', '), '.')
  cap.val <- gsub('^(.*), (.*)$', '\\1, and \\2', cap.val)
...
renderUI({
  ...
  cap.val<-paste0('Top five selected models for crab carapace length at shallow and deep water. Input variables were ', paste(tolower(sort(crvrs)), collapse = ', '), '.')
  cap.val <- gsub('^(.*), (.*)$', '\\1, and \\2', cap.val)
...
renderUI({
  ...
  cap.val<-paste0('Top five selected models for crab dissolution at shallow and deep water. Input variables were ', paste(tolower(sort(crvrs)), collapse = ', '), '.')
  cap.val <- gsub('^(.*), (.*)$', '\\1, and \\2', cap.val)
