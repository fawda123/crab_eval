...
```{r, fig.height = 7, fig.width = 7, fig.cap = ''}
...
Baseline pHdelt is mean of phDelt observations for 60m.  Pre-industrial is the baseline phDelt - 6 \* 0.02 (estimated decadal change for six decades).   Post-industrial is the basdline phDelt + 8 \* 0.02 (estimated decadal change for 8 decades)
```{r}
...
decchn <- 0.02
bsedlt <- mean(toplo$pHdelt)
df <- data.frame(
    pHdelt = c(bsedlt - 6 * 0.02, bsedlt, bsedlt + 8 * 0.02), 
