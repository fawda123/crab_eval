...
Baseline pHdelt is mean of phDelt observations for 60m.  Pre-industrial is the baseline phDelt - 2 \* 0.01 (estimated decadal change for two decades prior).   Post-industrial is the baseline phDelt + 2 \* 0.01 (estimated decadal change for 2 decades post)
```{r}
...
df <- data.frame(
    pHdelt = c(bsedlt - 2 * 0.01, bsedlt, bsedlt + 2 * 0.01), 
