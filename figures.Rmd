...
Estimated linear relationships between different pH gradients and disslution. a) $\Delta pH_{60}$ and relative external dissolution (R2 = 0.90; p < 0.001).  b) Depth-integrated pH at 60mband relative internal dissolution (R2 = 0.38; p = 0.078). c) Comparison of the relative external and internal dissolution (R2 = 0.24; p = 0.18). d) Relative external dissolution and carapace width (R2 = 0.57; p = 0.08).  Dotted lines show the linear regression fit between all points.  The solid line in (c) is the 1:1 line and the green line in (d) is the regression fit only through the onshore points. See methods for explanation of the term relative dissolution. 
